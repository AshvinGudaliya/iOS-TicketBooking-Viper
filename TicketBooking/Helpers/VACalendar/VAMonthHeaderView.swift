...
public struct VAMonthHeaderViewAppearance {
    ...
    public init(
        ...
        monthTextColor: UIColor = UIColor.label,
...
public class VAMonthHeaderView: UIView {
    ...
    public override func layoutSubviews() {
        ...
        monthLabel.frame = CGRect(x: 20, y: 0, width: appearance.monthTextWidth, height: frame.height)
        previousButton.frame = CGRect(x: self.bounds.width - (buttonWidth * 2), y: 0, width: buttonWidth, height: frame.height)
        nextButton.frame = CGRect(x: self.bounds.width - buttonWidth, y: 0, width: buttonWidth, height: frame.height)
    }
